...
# avrdude requires 'm8')
PROGRAMMER_MCU=$project.programmer_mcu
...
# 
AVRDUDE_PROGRAMMERID=$project.programmerid

# port--serial or parallel port to which your 
# hardware programmer is attached
#
AVRDUDE_PORT=$project.port
...
writeflash: hex
	$(AVRDUDE) -c $(AVRDUDE_PROGRAMMERID)   \
	 ...
	 -U flash:w:$(HEXROMTRG) -u -U eeprom:w:$(EEPROMFILE)
