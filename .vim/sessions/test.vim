" ~/core/.vim/sessions/test.vim: Vim session script.
" Created by session.vim on 18 September 2010 at 14:21:34.
...
silent only
cd ~/projects/rails_tutorial/sample_app
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 spec/models/user_spec.rb
args spec/models/user_spec.rb
